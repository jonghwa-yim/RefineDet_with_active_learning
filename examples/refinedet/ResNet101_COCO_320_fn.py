...
def run_COCO_detector_training(mode):
    ...
    train_data = COCO_NAMEs[mode]['train_data']
    ...
    job_name = COCO_NAMEs[mode]['job_name'].format(resize)
    ...
    train_net_file = COCO_NAMEs[mode]['train_net_file'].format(save_dir)
