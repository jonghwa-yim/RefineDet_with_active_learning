...
from test_refinedet.lib.fast_rcnn.config import cfg
from test_refinedet.lib.nms.gpu_nms import gpu_nms
from test_refinedet.lib.nms.cpu_nms import cpu_nms, cpu_soft_nms
import numpy as np
